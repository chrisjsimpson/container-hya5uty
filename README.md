...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hya5uty.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hya5uty.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-hya5uty.git
cd container-hya5uty
```
...
```
docker attach container-hya5uty
```
